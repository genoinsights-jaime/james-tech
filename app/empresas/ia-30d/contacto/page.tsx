...
export default function Ia30dContactPage() {
  return (
    <main className="min-h-screen bg-white text-black">
      ...
      <section className="px-5 pb-12 pt-24 md:px-6 md:pb-16 md:pt-30 xl:px-10">
        <div className="mx-auto grid max-w-[1300px] gap-8 lg:grid-cols-[minmax(0,0.88fr)_minmax(440px,0.72fr)] lg:items-start">
          <div className="lg:sticky lg:top-28">
            ...
            <div className="mb-6 lg:hidden">
              ...
              <h1 className="mt-4 font-sans text-[30px] font-semibold leading-[0.98] tracking-[-0.05em] text-black">
            ...
            <div className="hidden lg:block">
              ...
              <h1 className="mt-9 max-w-[9ch] font-sans text-[84px] font-semibold leading-[0.9] tracking-[-0.075em] text-black xl:text-[110px]">
                Diseñemos el primer paso.
              </h1>

              <p className="mt-7 max-w-[58ch] font-sans text-[21px] leading-[1.55] tracking-[-0.02em] text-black/68">
